      ...
      <AuthProvider>
        <Router>
          <Routes>
            ...
            {/* Routes utilisateurs */}
            <Route path="/dashboard/user" element={<PrivateRoute role="user"><UserLayout /></PrivateRoute>}>
            ...
            {/* Routes annonceurs */}
            <Route path="/dashboard/announcer" element={<PrivateRoute role="announcer"><OfferProvider><AnnouncerLayout /></OfferProvider></PrivateRoute>}>
            ...
            {/* Routes admin */}
            <Route path="/dashboard/admin" element={<PrivateRoute role="admin"><AdminLayout /></PrivateRoute>}>
